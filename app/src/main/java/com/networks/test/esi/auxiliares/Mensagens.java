...
public class Mensagens {
    ...
    public static void mensagem(Context context, int titulo, int texto){
        ...
        if(titulo==R.string.parametros_incorretos_string) dlg.setMessage(R.string.parametros_incorretos_string);
        ...
        if(texto==R.string.cliente_existente_string) dlg.setMessage(R.string.cliente_existente_string);
